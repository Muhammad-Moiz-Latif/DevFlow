...
export const NotificationType = pgEnum("notificationType", ['ISSUE_ASSIGNED', 'ISSUE_UNASSIGNED', 'COMMENT_ON_ISSUE', 'MENTIONED', 'INVITE_ACCEPTED', 'INVITE_ISSUED', 'REMOVED']);
